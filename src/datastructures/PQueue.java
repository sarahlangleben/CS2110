...
public interface PQueue<E> {
    /**
     * Return a string that represents this priority queue, in
     * this format:<br>
     * {@code [item0:priority0, item1:priority1, ..., item(N-1):priority(N-1)]}<br>
     * Thus, the list is delimited by '[' and ']', and items are separated
     * by ", " (i.e., a comma and a space char).
     */
    String toString();
